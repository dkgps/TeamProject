...
<script type="text/javascript">
	...
	function msg(box) {
		...
		if (image == "images/box.PNG") {
			...
			if (box == 'box1') {
				$(function() {
					location.href='storeform.jsp?no=1&floor=2';	
				...
				$(function() {
					location.href='storeform.jsp?no=2&floor=2';	
					$("#box2").attr("src", "images/box_in.png");
					$("#box2_1").text(name);
				});
			} else if (box == 'box3') {
				$(function() {
					location.href='storeform.jsp?no=3&floor=2';	
					$("#box3").attr("src", "images/box_in.png");
					$("#box3_1").text(name);
				});
			} else if (box == 'box4') {
				$(function() {
					location.href='storeform.jsp?no=4&floor=2';	
					$("#box4").attr("src", "images/box_in.png");
					$("#box4_1").text(name);
				});
			} else if (box == 'box5') {
				$(function() {
					location.href='storeform.jsp?no=5&floor=2';	
					$("#box5").attr("src", "images/box_in.png");
					$("#box5_1").text(name);
				});
			} else if (box == 'box6') {
				$(function() {
					location.href='storeform.jsp?no=6&floor=2';	
					$("#box6").attr("src", "images/box_in.png");
					$("#box6_1").text(name);
				});
			} else if (box == 'box7') {
				$(function() {
					location.href='storeform.jsp?no=7&floor=2';	
					$("#box7").attr("src", "images/box_in.png");
					$("#box7_1").text(name);
				});
			} else if (box == 'box8') {
				$(function() {
					location.href='storeform.jsp?no=8&floor=2';	
					$("#box8").attr("src", "images/box_in.png");
					$("#box8_1").text(name);
				});
			} else if (box == 'box9') {
				$(function() {
					location.href='storeform.jsp?no=9&floor=2';	
					$("#box9").attr("src", "images/box_in.png");
					$("#box9_1").text(name);
				});
			} else if (box == 'box10') {
				$(function() {
					location.href='storeform.jsp?no=10&floor=2';	
					$("#box10").attr("src", "images/box_in.png");
					$("#box10_1").text(name);
				});
			} else if (box == 'box11') {
				$(function() {
					location.href='storeform.jsp?no=11&floor=2';	
...
<%
	...
	ArrayList<String> s1 = sd1.getStatus("2");
...
<div id="floor">
	...
	<p class="box1">
		<input type="image" id="box1" name="box1" src="images/box.PNG"
			alt="submit" width="80px" height="80px" onclick="msg('box1')">
	...
	<p class="box1">
		<input type="image" id="box1" name="box1"
			...
			height="80px" onclick="msg('box1')">
	<p class="box1_1" id="box1_1"><%=sd1.getSNAME("2", "1")%></p>
	</p>
	<%} %>
	...
	<p class="box2">
		<input type="image" id="box2" name="box2" src="images/box.PNG"
			alt="submit" width="80px" height="80px" onclick="msg('box2')">
	...
	<p class="box2">
		<input type="image" id="box2" name="box2"
			src="images/box_in.png" alt="submit" width="80px"
			height="80px" onclick="msg('box2')">
	<p class="box2_1" id="box2_1"><%=sd1.getSNAME("2", "2")%></p>
	</p>
	<%} %>
	...
	<p class="box3">
		<input type="image" id="box3" name="box3" src="images/box.PNG"
			alt="submit" width="80px" height="80px" onclick="msg('box3')">
	...
	<p class="box3">
		<input type="image" id="box3" name="box3"
			src="images/box_in.png" alt="submit" width="80px"
			height="80px" onclick="msg('box3')">
	<p class="box3_1" id="box3_1"><%=sd1.getSNAME("2", "3")%></p>
	</p>
	<%} %>
	...
	<p class="box4">
		<input type="image" id="box4" name="box4" src="images/box.PNG"
			alt="submit" width="80px" height="80px" onclick="msg('box4')">
	...
	<p class="box4">
		<input type="image" id="box4" name="box4"
			src="images/box_in.png" alt="submit" width="80px"
			height="80px" onclick="msg('box4')">
	<p class="box4_1" id="box4_1"><%=sd1.getSNAME("2", "4")%></p>
	</p>
	<%} %>
	...
	<p class="box5">
		<input type="image" id="box5" name="box5" src="images/box.PNG"
			alt="submit" width="50px" height="60px" onclick="msg('box5')">
	...
	<p class="box5">
		<input type="image" id="box5" name="box5"
			src="images/box_in.png" alt="submit" width="50px"
			height="60px" onclick="msg('box5')">
	<p class="box5_1" id="box5_1"><%=sd1.getSNAME("2", "5")%></p>
	</p>
	<%} %>
	...
	<p class="box6">
		<input type="image" id="box6" name="box6" src="images/box.PNG"
			alt="submit" width="50px" height="60px" onclick="msg('box6')">
	...
	<p class="box6">
		<input type="image" id="box6" name="box6"
			src="images/box_in.png" alt="submit" width="50px"
			height="60px" onclick="msg('box6')">
	<p class="box6_1" id="box6_1"><%=sd1.getSNAME("2", "6")%></p>
	</p>
	<%} %>
	...
	<p class="box7">
		<input type="image" id="box7" name="box7" src="images/box.PNG"
			alt="submit" width="140px" height="40px" onclick="msg('box7')">
	...
	<p class="box7">
		<input type="image" id="box7" name="box7"
			src="images/box_in.png" alt="submit" width="140px"
			height="40px" onclick="msg('box7')">
	<p class="box7_1" id="box7_1"><%=sd1.getSNAME("2", "7")%></p>
	</p>
	<%} %>
	...
	<p class="box8">
		<input type="image" id="box8" name="box8" src="images/box.PNG"
			alt="submit" width="70px" height="70px" onclick="msg('box8')">
	...
	<p class="box8_1" id="box8_1"><%=sd1.getSNAME("2", "8")%></p>
	</p>
	<%} %>
	...
	<p class="box9">
		<input type="image" id="box9" name="box9" src="images/box.PNG"
			alt="submit" width="70px" height="70px" onclick="msg('box9')">
	...
	<p class="box9">
		<input type="image" id="box9" name="box9"
			src="images/box_in.png" alt="submit" width="70px"
			height="70px" onclick="msg('box9')">
	<p class="box9_1" id="box9_1"><%=sd1.getSNAME("2", "9")%></p>
	</p>
	<%} %>
	...
	<p class="box10">
		<input type="image" id="box10" name="box10"
			src="images/box.PNG" alt="submit" width="70px" height="70px"
			onclick="msg('box10')">
	...
	<p class="box10">
		<input type="image" id="box10" name="box10"
			src="images/box_in.png" alt="submit" width="70px"
			height="70px" onclick="msg('box10')">
	<p class="box10_1" id="box10_1"><%=sd1.getSNAME("2", "10")%></p>
	</p>
	<%} %>
	...
	<p class="box11">
		<input type="image" id="box11" name="box11"
			src="images/box_in.png" alt="submit" width="70px"
			height="70px" onclick="msg('box11')">
	<p class="box11_1" id="box11_1"><%=sd1.getSNAME("2", "11")%></p>
	</p>
	<%} %>
	<p class="blank1">
		<br>
